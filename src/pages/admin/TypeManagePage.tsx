        ...
        <div className="bg-[var(--color-canvas)] rounded-[var(--radius-xl)] shadow-[var(--shadow-l2)] p-5 mb-4">
          ...
          <div className="flex flex-col gap-2 mb-3">
            ...
            <div className="flex items-center justify-between mb-1">
              <label className="text-xs font-medium text-[var(--color-body)]">HTML 模板 prompt</label>
              <button
                type="button"
            ...
            <textarea
              placeholder="HTML 模板 prompt，含 ${analysis_json} 占位符。或者直接上传 .html 文件"
              value={newHtmlPrompt}
                    ...
                    {editingId === t.id ? (
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-[var(--color-mute)]">HTML 模板 prompt</span>
                          <button
                            type="button"
                        ...
                        <textarea
                          ...
                          placeholder="HTML 模板 prompt，含 ${analysis_json} 占位符"
                          rows={4}
                          className="w-full px-2 py-1 text-xs bg-[var(--color-canvas)] border border-[var(--color-hairline)] rounded-[var(--radius-sm)] font-mono resize-y"
                        />
                      </div>
