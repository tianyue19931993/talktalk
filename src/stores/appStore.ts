...
export async function updateType(id: string, data: {
  ...
  if (data.lookComponent !== undefined) p.look_component = data.lookComponent
  ...
  if (data.challengeComponent !== undefined) p.challenge_component = data.challengeComponent
